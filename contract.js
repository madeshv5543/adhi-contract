...
var contract = (function(module) {
          ...
          return new Promise(function(accept, reject) {
            var callback = function(error, tx) {
              ...
              var make_attempt = function() {
                C.web3.adh.getTransactionReceipt(tx, function(err, receipt) {
  ...
  function Contract(contract) {
    ...
    if (typeof contract == "string") {
      ...
      var contract_class = constructor.web3.adh.contract(this.abi);
    ...
    this.sendTransaction = Utils.synchronizeFunction(function(tx_params, callback) {
      ...
      constructor.web3.adh.sendTransaction.apply(constructor.web3.adh, [tx_params, callback]);
    }, this, constructor);
  ...
  Contract._static_methods = {
    ...
    new: function() {
      ...
      return self.detectNetwork().then(function(network_id) {
        ...
        return new Promise(function(accept, reject) {
          var contract_class = self.web3.adh.contract(self.abi);
          var tx_params = {};
          var last_arg = args[args.length - 1];
    ...
    at: function(address) {
      ...
      contract.then = function(fn) {
        return self.detectNetwork().then(function(network_id) {
          ...
          return new Promise(function(accept, reject) {
            self.web3.adh.getCode(address, function(err, code) {
